...
stackdriver:
  ...
  project_id: {{ default .default.stackdriver.project_id .Values.stackdriver.project_id }}
  exporter:
    ...
    location: {{ default .default.stackdriver.exporter.location .Values.stackdriver.exporter.location }}
    bundle_delay_threshold: {{ default .default.stackdriver.exporter.bundle_delay_threshold .Values.stackdriver.exporter.bundle_delay_threshold }}
    ...
    metric_prefix: {{ default .default.stackdriver.exporter.metric_prefix .Values.stackdriver.exporter.metric_prefix }}
    skip_cmd: {{ default .default.stackdriver.exporter.skip_cmd .Values.stackdriver.exporter.skip_cmd }}
    timeout: {{ default .default.stackdriver.exporter.timeout .Values.stackdriver.exporter.timeout }}
    reporting_interval: {{ default .default.stackdriver.exporter.reporting_interval .Values.stackdriver.exporter.reporting_interval }}
  ...
  profiler:
    ...
    service: {{ default .default.stackdriver.profiler.service .Values.stackdriver.profiler.service }}
    service_version: {{ default .default.stackdriver.profiler.service_version .Values.stackdriver.profiler.service_version }}
    ...
    api_addr: {{ default .default.stackdriver.profiler.api_addr .Values.stackdriver.profiler.api_addr }}
    instance: {{ default .default.stackdriver.profiler.instance .Values.stackdriver.profiler.instance }}
    zone: {{ default .default.stackdriver.profiler.zone .Values.stackdriver.profiler.zone }}
    {{- else }}
